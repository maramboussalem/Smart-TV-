...
void employement::on_pushButton_Ajouter_clicked()
{
...
void employement::on_pushButton_Modifier_clicked()
{
...
void employement::on_pushButton_supprimer_clicked()
{
    int id_E = ui->lineEdit_IdE->text().toInt();
...
void employement::on_pushButton_Statistique_clicked()
{
    employes etmp;
        etmp.Statistique();
}

void employement::on_pushButton_Trie_clicked()
{
    employes etmp;
        etmp.trie();
}

void employement::on_pushButton_Recherche_clicked()
{
    int id_E = ui->lineEdit_IdE->text().toInt();
       employes etmp;
       etmp.Recherche(id_E);
...
void employement::on_pushButton_Email_clicked()
{
    employes etmp;
        QString email = ui->lineEdit_email->text();
        etmp.Email(email);
...
void employement::on_pushButton_Email_Envoie_clicked()
{
...
void employement::on_pushButton_PDF_clicked()
{
...
void employement::on_pushButton_Recherche_M_clicked()
{
    QString adresse = ui->lineEdit_adresse->text();
...
void employement::on_pushButton_Afficher_clicked()
{
a.write_to_arduino("1"); //envoyer 1 à arduino
}

void employement::on_pushButton_pasdaffichage_clicked()
{
a.write_to_arduino("0");  //envoyer 0 à arduino
}
void employement::update_label()
{
    data=a.read_from_arduino();

    if(data=="1")

        ui->label_e->setText("Afficher"); // si les données reçues de arduino via la liaison série sont égales à 1
    // alors afficher

    else if (data=="0")

        ui->label_e->setText("Pas d'affichage");   // si les données reçues de arduino via la liaison série sont égales à 0
     //alors  pas d'affichage
}
