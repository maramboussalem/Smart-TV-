#include "loginspon.h"
#include "ui_loginspon.h"
#include <QMainWindow>
#include <QMessageBox>
#include <QMap>
loginspon::loginspon(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::loginspon)
{
    ui->setupUi(this);
...
void loginspon::on_Connecter_clicked()
{
    // Obtenir l'adresse e-mail saisie et le mot de passe correspondant
       ...
       emailPasswords.insert("sponsore@gmail.com", "rached123");
...
void loginspon::on_Retour_clicked()
{
