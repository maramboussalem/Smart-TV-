  ...
  S()
{
  ...
  connect(ui->stats_2, SIGNAL(clicked()), this, SLOT(on_stats2_clicked()));
...
void Sponsors::on_button_ajouter_clicked()
{
   ...
   Entite_sponsors S(ID_SPONSOR, NUM_CONTRAT, CATEGORY, DURE_CONTRAT, NOM);
    if(S.ajouter())
    {
...
void Sponsors::on_pushButton_2_clicked()
{
    close();
}

void Sponsors::on_deleteBut_clicked()
{
...
void Sponsors::on_modifyButton_clicked()
{
...
void Sponsors::on_showButton_clicked()
{
    ...
    Entite_sponsors sponsor = S.getSponsorByID(selectedID);
...
void Sponsors::on_Reset_clicked()
{
...
void Sponsors::on_Reset_2_clicked()
{
...
void Sponsors::on_ranking_clicked()
{
    ui->tableView->setModel(S.rankingByNumContrat());
}


void Sponsors::on_ranking_2_clicked()
{
...
void Sponsors::on_stats_2_clicked()
{
...
void Sponsors::on_stats2_clicked()
{
...
void Sponsors::on_stats2_2_clicked()
{
    // Create an instance of the Sponsors class
        Entite_sponsors sponsors;
...
void Sponsors::on_stats2_3_clicked()
{
    // Create an instance of the Sponsors class
        Entite_sponsors sponsors;
...
void Sponsors::on_stats2_4_clicked()
{
    // Create an instance of the Sponsors class
        Entite_sponsors sponsors;
...
void Sponsors::on_stats2_5_clicked()
{
    // Create an instance of the Sponsors class
        Entite_sponsors sponsors;
...
void Sponsors::on_logo1_2_clicked()
{
...
void Sponsors::on_logo2_clicked()
{
    // Open a file dialog to select an image file
    QString fileName = "logo4.png";
...
void Sponsors::on_logo2_3_clicked()
{// Open a file dialog to select an image file
    QString fileName = "logo4.png";
...
void Sponsors::on_logo2_2_clicked()
{
    // Open a file dialog to select an image file
    QString fileName = "logo4.png";
...
void Sponsors::askChatbotAboutServices() {
...
void Sponsors::recherche(const QString& searchText) {
...
void Sponsors::on_reset_search_clicked()
{
