...
Entite_sponsors::Entite_sponsors()
{
    ID_SPONSOR = 0;
    NUM_CONTRAT = 0;
    CATEGORY = "";
...
Entite_sponsors::Entite_sponsors(int ID_SPONSOR, int NUM_CONTRAT, QString CATEGORY, QString DURE_CONTRAT, QString NOM)
{
...
int Entite_sponsors::getID_SPONSOR() { return ID_SPONSOR; }
int Entite_sponsors::getNUM_CONTRAT() { return NUM_CONTRAT; }
QString Entite_sponsors::getCATEGORY() { return CATEGORY; }
QString Entite_sponsors::getDURE_CONTRAT() { return DURE_CONTRAT; }
QString Entite_sponsors::getNOM() { return NOM; }
void Entite_sponsors::setID_SPONSOR(int ID_SPONSOR) { this->ID_SPONSOR = ID_SPONSOR; }
void Entite_sponsors::setNUM_CONTRAT(int NUM_CONTRAT) { this->NUM_CONTRAT = NUM_CONTRAT; }
void Entite_sponsors::setCATEGORY(QString CATEGORY) { this->CATEGORY = CATEGORY; }
void Entite_sponsors::setDURE_CONTRAT(QString DURE_CONTRAT) { this->DURE_CONTRAT = DURE_CONTRAT; }
void Entite_sponsors::setNOM(QString NOM) { this->NOM = NOM; }

bool Entite_sponsors::ajouter()
{
    QSqlQuery query;
    // Check if ID exists
...
QSqlQueryModel *Entite_sponsors::afficher()
{
...
bool Entite_sponsors::supprimer(int ID_SPONSOR)
{
    QSqlQuery query;
    query.prepare("SELECT ID_SPONSOR FROM SPONSORS WHERE ID_SPONSOR = :ID_SPONSOR");
    query.bindValue(":ID_SPONSOR", ID_SPONSOR);
...
bool Entite_sponsors::modifier(int ID_SPONSOR, int newNumContrat, const QString &newCategory, const QString &newDureContrat, const QString &newNom)
{
    QSqlQuery query;
    query.prepare("SELECT ID_SPONSOR FROM Sponsors WHERE ID_SPONSOR = :id_sponsor");
    query.bindValue(":id_sponsor", ID_SPONSOR);
...
Entite_sponsors Entite_sponsors::getSponsorByID(int ID_SPONSOR)
{
    QSqlQuery query;
...
QSqlQueryModel *Entite_sponsors::rankingByNumContrat()
{
    QSqlQueryModel *model = new QSqlQueryModel();
...
QSqlQueryModel *Entite_sponsors::rankingBycat()
{
    QSqlQueryModel *model = new QSqlQueryModel();
...
int Entite_sponsors::countType(const QString &category)
{
    QSqlQuery query;
...
void Entite_sponsors::createColorfulCircleChart()
{
...
bool Entite_sponsors::addQuestions(const QString &ques1, const QString &ques2, const QString &ques3, const QString &ques4, const QString &ques5)
{
...
int Entite_sponsors::retrieveCount(const QString &questionName, const QString &option)
{
    QSqlQuery query;
...
void Entite_sponsors::createStatsChart(const QString &questionName)
{
